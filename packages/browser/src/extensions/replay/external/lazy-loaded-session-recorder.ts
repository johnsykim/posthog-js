...
export class LazyLoadedSessionRecording implements LazyLoadedSessionRecordingInterface {
    ...
    constructor(private readonly _instance: PostHog) {
        ...
        // DEBUG: Verify local version is loaded with V2 trigger groups support
        logger.info('🚀 LOCAL V2 TRIGGER GROUPS VERSION LOADED - Build timestamp:', Date.now())
    }
    ...
    private _activateTrigger(triggerType: TriggerType, matchDetail?: string) {
        ...
        try {
            ...
            this._strategy?.updateActiveTriggers()
